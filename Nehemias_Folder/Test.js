function buildropdown() {
    ...
    d3.csv("Data/dates_clean.csv", function(data) {
        listid = [2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017]
...
function updateToolTip(chosenXAxis, circlesGroup) {
  ...
  var toolTip = d3.tip()
    ...
    .offset([80, -60])
    .html(function(d) {
      return (`${d.city_y}<br>${label} ${d[chosenXAxis]}`);
    });
...
d3.csv("Data/dates_clean.csv", function(err, data) {
  if (err) throw err;

  // parse data
  data.forEach(function(data) {
    data.host_since = +data.host_since;
    data.city_y = +data.city_y;
    data.year = +data.year;
  });
